        ...
        const dirtyInterval = setInterval(() => {
            setDirtyState(prevDirtyLevel => {
                ...
                const updatedPet = {
                    ...
                    isDirty: newDirtyLevel >= currentPet.dirtyThreshold
                };
        ...
        const lazyInterval = setInterval(() => {
            setLazyState(prevLazyLevel => {
                ...
                const updatedPet = {
                    ...
                    isLazy: newLazyLevel >= currentPet.lazyThreshold
                };
